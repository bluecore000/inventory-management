    ...
    <div class="row">
        ...
        <div class="col-xs-6">
          <div class="box box-primary">
            <div class="box-body"> 
            <h4 class="product-title">Company Products for Purchase &nbsp;:-</h4>             
  ...
  $('#companyname').change(function(){
    ...
    if(!company_id=='') {
      ...
      //  async: false,
        ...
        error: function() {
          alert('Opps! something wrong contact to  sri krishna');
        }
      });
    }
    else {
    ...
    for ( i = 0; i < item.length; i++) {
      ...
      $("<tr>"+
        ...
        "<td class='text-center'>"+
          ...
          "<input type='number' class='m-text unit' name='unit[]' min='0'>"+
        "</td>"+    
        "<td class='text-center'>"+
          "<input type='number' class='m-text pic' name='pic[]' min='0'>"+
        "</td>"+   
        "<td class='text-center'>"+
          "<input type='number' class='m-text qty' name='qty[]' min='0'>"+
        "</td>"+  
        "<td class='text-center'>"+
          "<input type='number' class='m-text rate' name='rate[]' min='0'>"+
        "</td>"+  
        "<td class='text-center'>"+
          "<input type='number' class='m-text amount' name='amount[]' min='0'>"+
        "</td>"+       
        "</tr>"       
